...
location = 'IN_OUT/';
Filling_glib_filename   = 'HRO_UFillings_HFSS';
outside_block_filename  = 'z_01210000_5x5_block';

output_filename = 'HRO_UFillings_CAD';
Cell_name = 'HRO_UFillings';
...
%% get the negative of the Outside_Mosaic_gstr 
    outer_solid_gstr = GDS_Merge(InOut_Mosaic_gstr{2},units*100);
...
%     GDS_plot_gstr(InOut_Mosaic_gstr{2},0,'k-'),hold on
    GDS_plot(outer_solid_gstr,'k-'),hold on
    GDS_plot(Filling_maskgelm,'r-.'),hold on
